// NOTE: (npyl): I removed Designer component which used extensively the form-render library.
//               These types below are probably necessary only if I bring it back, but keep them for now
//                  so that we don't break anything on the rest of the code.
